...
export const removedPriceGuideSlugs = [
...
export const nearbyPriceGuideMap: Record<string, string[]> = {
  "cost-to-buy-150k-house": ["cost-to-buy-200k-house", "cost-to-buy-250k-house"],
  ...
  "cost-to-buy-750k-house": ["cost-to-buy-500k-house", "cost-to-buy-600k-house"]
};
